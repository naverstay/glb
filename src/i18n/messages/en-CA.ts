...
export const English: Messages = {
  ...
  help1: `Every day, there is a new Mystery Country. Your goal is to guess the mystery country using the fewest number of guesses. Each incorrect guess will appear on the globe with a colour indicating how close it is to the Mystery Country. The hotter the colour, the closer you are to the answer.`,
  help2: `For example, if the Mystery Country is Brazil, then the following countries would appear with these colours if guessed:`,
